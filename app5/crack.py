	...
	def main(self):
		...
		for user in object:
			try:
				...
				if len(obj) == 1:
					listpass = [
						obj[0]+'123', obj[0]+'1234', obj[0]+'khan', obj[0]+'sharma', 'indian', 'india1', 'bhagwan', '786786',
						obj[0]+'12345', obj[0]+'Thakur', obj[0]+'Gupta', 'india123', 'indian123', 'khan123', 'Bahobali',
					]
