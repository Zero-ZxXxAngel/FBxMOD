...
import os, time
from kmz import config
from kmz import login
from kmz import crack
...
class Brute(object):
	def __init__(self, url):
		...
		self.menu = '\n'
		self.menu += ('  \033[1;91m[ \033[0;96m1\033[1;91m ]  \033[1;94mStart Crack\n')
		self.menu += ('  \033[1;91m[ \033[0;96m2\033[1;91m ]  \033[1;94mDM Id Friends\n')
		self.menu += ('  \033[1;91m[ \033[0;96m3\033[1;91m ]  \033[1;94mDM Id by Search name\n')
		self.menu += ('  \033[1;91m[ \033[0;96m4\033[1;91m ]  \033[1;94mDM Id from likes status\n')
                self.menu += ('  \033[1;91m[ \033[1;96m5\033[1;91m ]  \033[1;94mDM id Friends list\n')
                self.menu += ('  \033[1;91m[ \033[1;96m6\033[1;91m ]  \033[1;94mUpdate Script?\n')
		self.menu += ('  \033[1;91m[ \033[0;96m0\033[1;91m ]  \033[1;94mRemove cookies\n')
	...
	def main(self, response):
		...
		jalan('\033[1;91m      ________________________________________________________')
                print(' ')
                jalan('\t\t\t\033[1;93m(AMERIKA SERVER)')
		print(self.menu)
		try:
