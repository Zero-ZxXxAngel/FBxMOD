...
import os, time
from app3 import config
from app3 import login
from app3 import crack
...
class Brute(object):
	def __init__(self, url):
		...
		self.menu = '\n'
		self.menu += ('  \033[1;91m[ \033[0;96m1\033[1;91m ]  \033[1;91mStart Crack\n')
		self.menu += ('  \033[1;91m[ \033[0;96m2\033[1;91m ]  \033[1;91mDM Id Friends\n')
		self.menu += ('  \033[1;91m[ \033[0;96m3\033[1;91m ]  \033[1;91mDM Id by Search name\n')
		self.menu += ('  \033[1;91m[ \033[0;96m4\033[1;91m ]  \033[1;91mDM Id from likes status\n')
                self.menu += ('  [ \033[1;96m5\033[1;91m ]  \033[1;91mDM id Friends lists\n')
                self.menu += ('  [ \033[1;96m7\033[1;91m ]  \033[1;91mUpdate Script?\n')
		self.menu += ('  [ \033[0;96m0\033[1;91m ]  \033[1;91mRemove cookies\n')
	...
	def main(self, response):
		...
		jalan('\033[1;91m      ________________________________________________________')
                print(' ')
                jalan('\t\t\t\033[1;93m(BANGLADESH SERVER)')
		print(self.menu)
		try:
